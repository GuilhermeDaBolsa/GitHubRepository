...
import static SimplY.NodeManager.YDialogBaloonConstants.*;
 ...
 */
public class YDialogBaloon extends Pane {
    public Shape balao;
     ...
     */
    public YDialogBaloon(double largura, double altura, String direcao_cardinal,
        ...
        getChildren().addAll(balao, triangulo, texto);//FAZER A CLASSE TRIANGULOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOO
    }
     ...
     * @param cor_borda A cor da borda do balão.
     */
    public YDialogBaloon(String direcao_cardinal, boolean tera_animacao_entrada, String fala,
     ...
     * @param texto
     */
    public YDialogBaloon(double largura, double altura, Point2D inicio,
...
//        getChildren().addAll(balao, triangulo);
    ...
    /**
     * Método para direcionar o rabinho do balão do diálogo. //FAZER SO UMA FIGURA E IR ROTACIONANDO (FAZER UM METODO COM 2 PARAMETROS o 1º é o lado e o 2º a %do tamanho daquele lado vai estar o triangulo)
     *
    ...
    public void aparecer_balao(double largura, double altura, double duracao) {
        YAnimations.animacao_escala(balao, largura, altura, duracao);
    }
    ...
    public void aparecer_triangulo(double largura, double altura, double duracao) {
        if (triangulo != null) {
            YAnimations.animacao_escala(triangulo, largura, altura, duracao);
        }
    }
    ...
    public void aparecer_texto(double largura, double altura, double duracao) {
        YAnimations.animacao_escala(texto, largura, altura, duracao);
    }
