...
public class VisualizadorImagemEgif extends ImageView{//NAO TEM OS EVENTOS DE CLICKE AAAAAAAAAAAAAAAAAAAAAAAAAA NAO DA PRA EXTENDER 2 CLASSES AAAAAAAAA
     ...
     */
    public VisualizadorImagemEgif(String caminho_img_ou_gif){
     ...
     */
    public VisualizadorImagemEgif(String caminho_img_ou_gif, double largura, double altura) {
        super(new Image(new File(caminho_img_ou_gif).toURI().toString()));
        setFitWidth(largura);
